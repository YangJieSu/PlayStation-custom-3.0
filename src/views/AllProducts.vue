      ...
      <div class="row">
          ...
          <ul class="category-list d-flex flex-md-column justify-content-between mb-0 flex-wrap">
            ...
            <li>
              <a
                href="#"
                class="font-weight-bold mb-3"
                :class="{ 'active' : selected == 'Switch' }"
                @click.prevent="changeCategory('Switch');"
              >
                <img
                  src="../assets/images/Nintendo_Switch_icon.png"
                  class="d-none d-md-inline-block img-fluid"
                  width="50"
                  alt
                >
            ...
            <li>
              <a
                href="#"
                class="font-weight-bold mb-3"
                :class="{ 'active' : selected == 'PS4' }"
                @click.prevent="changeCategory('PS4');"
              >
                <img
                  src="../assets/images/ps4_icon.png"
                  class="d-none d-md-inline-block img-fluid"
                  width="50"
                  alt
                >
            ...
            <li>
              <a
                href="#"
                class="font-weight-bold mb-3"
                :class="{ 'active' : selected == 'N3DS' }"
                @click.prevent="changeCategory('N3DS');"
              >
                <img
                  src="../assets/images/n3ds_icon.png"
                  class="d-none d-md-inline-block img-fluid"
                  width="50"
                  alt
                >
        ...
        <div class="col-md-8 col-lg-10 d-none d-sm-block">
          <div
            ...
            v-if="searchFilter && searchResult.length == 0"
...
export default {
  ...
  computed: {
    ...
    filterData() {
      ...
      return vm.filterProd.filter((item, index) => index < nowPage * vm.pagination.filterPageSize
